            ...
            for overlap in range(min(i-2,maxOverlap)+1):
                ...
                if validness == 1:
                    if newGraph not in G[i]:
                        if i <= 4:
                            if DetermineLevels(newGraph,i) <= 4 and len(newGraph) <= 4: #4
                                G[i].append(newGraph)
                                print(f"{i}-bit Graphs created :{len(G[i])}")
                        elif i == 5:
                            if DetermineLevels(newGraph,i) <= 4 and len(newGraph) <= 5: #5
                                G[i].append(newGraph)
                                print(f"{i}-bit Graphs created :{len(G[i])}")
                        elif i == 6:
                            ...
                            if DetermineLevels(newGraph,i) <= 4 and len(newGraph) <= 8: #9
                                G[i].append(newGraph)
                                print(f"{i}-bit Graphs created :{len(G[i])}")
                        elif i == 8:
                            if DetermineLevels(newGraph,i) <= 4 and len(newGraph) <= 11: #12
                                G[i].append(newGraph)
                                print(f"{i}-bit Graphs created :{len(G[i])}")
                        elif i == 9:
                            if DetermineLevels(newGraph,i) <= 4 and len(newGraph) <= 12: #13
                                G[i].append(newGraph)
                                print(f"{i}-bit Graphs created :{len(G[i])}")
                        elif i == 10:
                            if DetermineLevels(newGraph,i) <= 4 and len(newGraph) <= 14: #15
                                G[i].append(newGraph)
                                print(f"{i}-bit Graphs created :{len(G[i])}")
                        elif i == 11:
                            if DetermineLevels(newGraph,i) <= 4 and len(newGraph) <= 16: #17
                                G[i].append(newGraph)
                                print(f"{i}-bit Graphs created :{len(G[i])}")
                        elif i == 12:
                            if DetermineLevels(newGraph,i) <= 4 and len(newGraph) <= 19: #20
                                G[i].append(newGraph)
                                print(f"{i}-bit Graphs created :{len(G[i])}")
                        elif i == 13:
                            if DetermineLevels(newGraph,i) <= 4 and len(newGraph) <= 21: #22
                                G[i].append(newGraph)
                                print(f"{i}-bit Graphs created :{len(G[i])}")
                        elif i == 14:
                            if DetermineLevels(newGraph,i) <= 4 and len(newGraph) <= 24: #25
                                G[i].append(newGraph)
                                print(f"{i}-bit Graphs created :{len(G[i])}")
                        elif i == 15:
                            if DetermineLevels(newGraph,i) <= 4 and len(newGraph) <= 27: #28
                                G[i].append(newGraph)
                                print(f"{i}-bit Graphs created :{len(G[i])}")
                        elif i == 16:
                            if DetermineLevels(newGraph,i) <= 4 and len(newGraph) <= 31: #32
                                G[i].append(newGraph)
                                print(f"{i}-bit Graphs created :{len(G[i])}")
                elif validness == 2:
